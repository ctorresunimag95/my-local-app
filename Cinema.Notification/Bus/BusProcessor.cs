...
namespace Cinema.Notification.Bus;

internal sealed class BusProcessor : IAsyncDisposable
{
    ...
    public async Task StartProcessorAsync()
    {
        var processor = _serviceBusClient.CreateProcessor("movie.management.topic",
            "movie.management.notification.subscription", new ServiceBusProcessorOptions
            {
